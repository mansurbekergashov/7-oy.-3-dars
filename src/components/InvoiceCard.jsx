...
export default function InvoiceCard({
  ...
  return ( 
    <div onClick={()=>handleClick(id)} className="py-4 px-8 rounded-xl shadow-md flex justify-between border-transparent cursor-pointer border-2 hover:border-blue-500 group">
